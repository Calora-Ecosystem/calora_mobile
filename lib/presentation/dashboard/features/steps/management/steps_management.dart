...
abstract class StepsState with _$StepsState {
  const factory StepsState({
    ...
    @Default(MetricsRequest(foots: 0, distance: 0, kcal: 0)) MetricsRequest dailyMetrics,
    @Default(MetricsRequest(foots: 0, distance: 0, kcal: 0)) MetricsRequest weeklyMetrics,
    @Default(MetricsRequest(foots: 0, distance: 0, kcal: 0)) MetricsRequest monthlyMetrics,
